...
@Profile("!test")
	...
	@Autowired
	@Lazy
	private lateinit var self: InitData
	...
	private fun insertSeller() {
		...
		val sellerSignupRequest = SellerSignupRequest.builder()
			.username("seller0001")
	...
	private fun insertCustomer() {
		...
		val customerSignupRequest = CustomerSignupRequest.builder()
	...
	fun insertGPU() {
		self.insertItem(2L, "COLORFUL 지포스 RTX 4060 토마호크 DUO V2 D6 8GB", "https://i.ibb.co/zWfM4PsD/COLORFUL-RTX-4060-DUO-V2-D6-8-GB.webp")
		self.insertItem(2L, "갤럭시 GALAX 지포스 RTX 5080 WHITE OC D7 16GB", "https://i.ibb.co/rK1D4KXY/GALAX-RTX-5080-WHITE-OC-D7-16-GB.jpg")
		self.insertItem(2L, "MSI 지포스 RTX 5080 뱅가드 SOC D7 16GB 하이퍼프로져", "https://i.ibb.co/yndbCTrk/MSI-RTX-5080-SOC-D7-16-GB.jpg")
		self.insertItem(2L, "PALIT 지포스 RTX 5080 GAMEROCK OC D7 16GB 이엠텍", "https://i.ibb.co/HL5xzPwC/PALIT-RTX-5080-GAMEROCK-OC-D7-16-GB.jpg")
		self.insertItem(2L, "이엠텍 지포스 RTX 4060 STORM X Dual OC D6 8GB", "https://i.ibb.co/JRSmMsbK/RTX-4060-STORM-X-Dual-OC-D6-8-GB.jpg")
		self.insertItem(2L, "이엠텍 지포스 RTX 4060 MIRACLE WHITE D6 8GB", "https://i.ibb.co/ksvLHxM0/RTX-4060-MIRACLE-WHITE-D6-8-GB.jpg")
	}

	fun insertRAM() {
		self.insertItem(3L, "마이크론 Crucial DDR5-6400 CL38 PRO Overclocking 패키지 대원씨티에스 (32GB(16Gx2))", "https://i.ibb.co/V05VjVH7/Crucial-DDR5-6400-CL38-PRO-Overclocking-32-GB-16-Gx2.jpg")
		self.insertItem(3L, "G.SKILL DDR5-6400 CL32 TRIDENT Z5 ROYAL 실버 패키지 (32GB(16Gx2))", "https://i.ibb.co/b5s7ZVjT/G-SKILL-DDR5-6400-CL32-TRIDENT-Z5-ROYAL-32-GB-16-Gx2.jpg")
		self.insertItem(3L, "GeIL DDR5-6000 CL38 ORION V RGB White 패키지 (32GB(16Gx2))", "https://i.ibb.co/CKtZHSTB/Ge-IL-DDR5-6000-CL38-ORION-V-RGB-White-32-GB-16-Gx2.jpg")
		self.insertItem(3L, "G.SKILL DDR5-6000 CL30 RIPJAWS M5 RGB 화이트 패키지 (32GB(16Gx2))", "https://i.ibb.co/S4w2DX8J/G-SKILL-DDR5-6000-CL30-RIPJAWS-M5-RGB-32-GB-16-Gx2.jpg")
		self.insertItem(3L, "CORSAIR DDR5-6000 CL30 VENGEANCE RGB DP WHITE 패키지 (32GB(16Gx2))", "https://i.ibb.co/mCzdwx1B/CORSAIR-DDR5-6000-CL30-VENGEANCE-RGB-DP-WHITE-32-GB-16-Gx2.jpg")
		self.insertItem(3L, "G.SKILL DDR5-6000 CL30 TRIDENT Z5 NEO RGB J 화이트 패키지 (64GB(32Gx2))", "https://i.ibb.co/v4Dm2sVn/G-SKILL-DDR5-6000-CL30-TRIDENT-Z5-NEO-RGB-J-64-GB-32-Gx2.jpg")
	}
